...
class TaskActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun addNewCategory(){
        ...
        bindingAddCategory.newCategoryName.text.clear()
        ...
        bindingAddCategory.newCategoryOk.setOnClickListener {
            ...
            lifecycleScope.launch(Dispatchers.IO) {
                val categoryNames = categoryDatabase.categoryDao().getCategoriesNames()
                if(newCategory in categoryNames) {
                    ...
                    categoryDatabase.categoryDao().insertCategory(CategoryModel(newCategory))
                    val job = async(Dispatchers.Main) {
                        val spinnerAdapter = binding.spinnerCategory.adapter as ArrayAdapter<String>
        ...
        if (TextUtils.isEmpty(title))
            ...
            lifecycleScope.launch(Dispatchers.IO) {
                val job = async {
                    ...
                    todoDatabase.todoDao().insertTask(
                        TodoModel(
                            title,
                            description,
                            category,
